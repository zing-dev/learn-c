...
double subleg(), sublagr(), subhemt();  /* ����Ҫ���õ������Ӻ���*/
if((a<-1.0e34) && (b>1.0e34))            /* ������Ϊ��������(-inf,inf)*/
z = subhemt(f);
else if((a<-1.0e34) && (b<0))            /* ������Ϊ����������(-inf,b),b<0*/
{
z1 = sublagr(b - 1.0, 0.0, eps, nmax, f, -1);
z2 = subleg(b - 1.0, b, 0.0, eps, nmax, f);
z = z1 + z2;
}
else if(a<-1.0e34)                       /* ������Ϊ����������(-inf,b),b>=0*/
{
z1 = sublagr(-b - 1.0, 0.0, eps, nmax, f, -1);
z2 = subleg(-b - 1.0, b, 0.0, eps, nmax, f);
z = z1 + z2;
}
else if((a<0) && (b>1.0e34))             /* ������Ϊ����������(a,inf),a<0*/
{
z1 = sublagr(-a + 1.0, 0.0, eps, nmax, f, 1);
z2 = subleg(a, -a + 1.0, 0.0, eps, nmax, f);
z = z1 + z2;
}
else if(b>1.0e34)                        /* ������Ϊ����������(a,inf),a>=0*/
{
z1 = sublagr(a + 1.0, 0.0, eps, nmax, f, 1);
z2 = subleg(a, a + 1.0, 0.0, eps, nmax, f);
z = z1 + z2;
...
z1 = z1 * h;                             /* ������(2x0,x0)�Ļ��ֽ���ֵ*/
for(
j = 0;
j<5; j++)
z2 = z2 + cr[j] * (*f)(x0 + x0 - tr[j]);     /* ������(-inf,2x0)�Ļ��ֽ���ֵ*/
d = fabs(z0 - (z1 + z2));
}
else                                     /* ��ʱx0>0*/
{
...
j<5; j++)
z1 = z1 + cg[j] * (*f)(h * tg[j] + x);
z1 = z1 * h;                             /* ������(x0,2x0)�Ļ��ֽ���ֵ*/
for(
j = 0;
j<5; j++)
z2 = z2 + cr[j] * (*f)(x0 + x0 + tr[j]);     /* ������(2x0,inf)�Ļ��ֽ���ֵ*/
d = fabs(z0 - (z1 + z2));
}
z = z1 + z2;
